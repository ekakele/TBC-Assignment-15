...
struct Movie {
    ...
    init(image: UIImage?, title: String, genre: MovieGenre, rating: Double, certificate: String, runtime: String, release: String, director: String, cast: String, description: String, ratingSource: String) {
        self.image = image
        self.title = title
        self.genre = genre
        self.rating = rating
